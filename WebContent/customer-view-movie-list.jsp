			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="panel panel-info" style="height:820px;">
					<div class="panel-body">
						<div class="form-row">
							<h4>
								<center><font color="Crimson"><%=retriveMovie.getString("movie_name")%></font></center>
							</h4>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<label>Cast.:</label> <%=retriveMovie.getString("cast")%>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								<label>Duration.:</label> <%=retriveMovie.getString("duration")%>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								<label>Description.:</label> <%=retriveMovie.getString("description")%>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								<label>Director.:</label> <%=retriveMovie.getString("director")%>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<a href="customer-book-movie.jsp?movieId=<%=retriveMovie.getInt("movie_id")%>" class="btn btn-primary">Book Movie</a>
							</div>
						</div>
					</div>
				</div>
